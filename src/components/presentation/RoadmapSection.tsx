      ...
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <div className="text-center space-y-3 max-w-3xl mx-auto">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-purple-500/10 border border-purple-500/20 text-purple-400 text-xs font-bold uppercase tracking-wider">
            ...
            <span>Strategic Execution Phasing</span>
          </div>
          <h2 className="text-3xl sm:text-5xl font-serif font-bold text-white tracking-tight">
            3-Phase Growth Roadmap
          </h2>
          <p className="text-sm sm:text-base text-slate-300">
            A disciplined, high-velocity roadmap scaling from Kota Kinabalu launch to state-wide corridor expansion and multi-million dollar annual ecosystem GMV.
          </p>
        </div>
